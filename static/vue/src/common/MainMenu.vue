<template>
  <div>
    ...
    <div class="mb-4">
      <Link class="flex items-center py-3 group" :href="$route('organization.search')">
        <icon name="office" class="w-4 h-4 mr-2 fill-white" />
        <div class="text-white">Organizations</div>
      </Link>
    </div>
    <div class="mb-4">
      <Link class="flex items-center py-3 group" :href="$route('contacts.search')">
